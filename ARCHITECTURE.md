...
Storage & ECR
VPC: healthsentinel-vpc (10.0.0.0/16)
IAM & Security Boundary
Isolated Database Subnets (10.0.20.0/24 & 10.0.21.0/24)
Private Subnets (10.0.10.0/24 & 10.0.11.0/24)
Public Subnets (10.0.1.0/24 & 10.0.2.0/24)
Amazon EKS Cluster: healthsentinel-cluster
Worker Nodes (t3.medium Autoscaling)
HTTPS / WSS
Port 80 -> 3000
Routing /api
Port 80 -> 8000
...
GitOps / ECR Push
GitOps / ECR Push
Read/Write Model Artifacts
Outbound updates
Pull Images
Pull Images
Pull Images
Secret/Volume Encryption
Assume Role
🩺 Clinical Users (Doctors/Nurses)
🛠️ DevOps / CI/CD (Jenkins)
🔑 KMS Key (healthsentinel-cluster-key)
👤 IAM Roles (EKS, SageMaker, NodeGroup)
🌐 Internet Gateway
⚡ NAT Gateway (15.224.78.255)
⚖️ Classic LB (Frontend)
⚖️ Classic LB (Backend)
📦 hs-frontend Pod (Next.js)
📦 hs-backend Pod (FastAPI)
📦 hs-ai Pod (FastAPI ClusterIP)
🗄️ RDS PostgreSQL 16 (healthsentinel-db)
🪣 S3 Bucket (sagemaker-eu-west-3-856021349334)
🪣 S3 Bucket (healthsentinel-state-v2)
🏷️ ECR: healthsentinel-frontend
🏷️ ECR: healthsentinel-backend
🏷️ ECR: healthsentinel-api
🖥️ SageMaker Studio
🧠 SageMaker Model (Scikit-Learn)
...
Autoscaling Group	Min: 1, Max: 5, Desired: 2	Dynamically scales based on CPU/Memory load.
...
│   └── Policies: AmazonEKSWorkerNodePolicy, AmazonEKS_CNI_Policy, AmazonEC2ContainerRegistryReadOnly, AmazonEBSCSIDriverPolicy
└── Role: AmazonSageMakerAdminHTMLexecutionRole (SageMaker Pipeline Role)
    ├── Trusted Entity: sagemaker.amazonaws.com
    └── Policies: AmazonSageMakerFullAccess, AmazonS3FullAccess (Restricted to healthsentinel buckets)
